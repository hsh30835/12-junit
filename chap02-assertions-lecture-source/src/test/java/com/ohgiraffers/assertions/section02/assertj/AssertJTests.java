...
public class AssertJTests {
    ...
    * */
    ...
    // 날짜 객체가 가지는 년,월,일,시,분,초, 밀리초, 나노초 까지도 검증이 가능하며, 특정 날자 범위, 이전, 이후 내용도 검증이 가능하다.
    @Test
    @DisplayName("날짜 텍스트 하기")
...
//                .hasMessageContaining("파라미터");
    ...
    void testExtractProperty() {
        ...
        List<String> expected = Arrays.asList("홍길동", "유관순", "이순신", "신사임당", "임꺽정","123");
