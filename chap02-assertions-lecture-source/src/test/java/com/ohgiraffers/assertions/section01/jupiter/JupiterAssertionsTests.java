...
//        Assertions.assertFalse(result);
    ...
    void testAssertAll(){
        ...
        Assertions.assertAll(
                ...
                () -> Assertions.assertNotEquals(lastName, person.getFirstName(), "lastName이 잘못됨")
                //AssertNotEquals.assertNotEquals(unexpected, actual, message); unexpected와 actual의 값이 다를때 true
        );
    }
...
//        );
        ...
        Assertions.assertAll(
                ...
                () -> Assertions.assertInstanceOf(IllegalAccessError.class, exception), // 예외 비교
                () -> Assertions.assertDoesNotThrow(() -> validator.checkDividableNumbers(secondNum,firstNum)), // 오류가 안나는 경우
