package com.ohgiraffers.section03.addtional;
...
public class AdditionalAnnotation {
    ...
    * */
    ...
    // edit 에서 configuration에서 따로 지정해서 실행할 수 있다 여러개 실행할려면 &나 | 연산자 사용
    ...
    * 클래스에 작성한 테스트 메소드의 순서는 MethodOrder에 DisplayName, MethodName, OrderAnnotation, Random 등이있다.
    * */
    ...
    /*
    * RepeatedTest는 명시도니 숫자로 얼마나 테스트를 반복할 것인지를 지정해서 사용한다.
    * 반복한 테스트 메소드의 호출은 보통의 @Test 메소드들이랑 똑같이 동작한다.
    * */
    @RepeatedTest(10)
